...
if(!isset($_COOKIE['COOKIES_MEMBER'])){
 ...
 <!-- App Capsule -->
    <div id="appCapsule">
        ...
        <a href="./"><img src="\absensi\sw-mod\sw-assets\img\lgpng.png"  oncontextmenu="return false;" height="150"></a>

            <h1>Politeknik Tridaya Virtu Morosi</h1>
            <h4>Login menggunakan Email dan Password</h4>
        </div>
        <div class="section mb-5 p-2">
            ...
            <form id="form-login">
                ...
                <div class="form-button-group  transparent">
                   <button type="submit" class="btn btn-primary btn-block"><ion-icon name="log-in-outline"></ion-icon> Login / Masuk</button>
