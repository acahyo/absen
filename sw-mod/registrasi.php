...
$kode_karyawan = $huruf . sprintf("%03s", $urutan);
 ...
 <!-- App Capsule -->
    <div id="appCapsule">
        ...
        <h1>Mendaftar Akun Presensi PTVM</h1>
        </div>
                    ...
                    <div class="card-body pb-1">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="password" class="form-control" id="password" name="employees_password" placeholder="Buat Password Login Presensi PTVM">
                                <i class="clear-input"><ion-icon name="close-circle"></ion-icon></i>
                            </div>
                        </div>
                    </div>
