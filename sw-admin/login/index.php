...
<head>
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    ...
    <!-- Icons -->
    <link rel="shortcut icon" href="../../sw-content/lgpng.png">
    <link rel="apple-touch-icon" href="../../sw-content/lgpng.png">
...
<div class="login-box">
  <div class="login-logo">
    <a href="./"><img src="../../sw-content/'.$site_logo.'"  oncontextmenu="return false;" height="100"></a>
  </div>
  <!-- /.login-logo -->
